...
function getIntersectionXPoint(segment, xPos, yPos) {
    ...
    if (Math.abs(dy1) < exports.EPS) {
        // The segment starts on the sweep line
        if (Math.abs(dy) < exports.EPS) {
...
exports.getIntersectionXPoint = getIntersectionXPoint;
...
function same(x0, x1, y0, y1) {
    return Math.abs(x0 - x1) < exports.EPS && Math.abs(y0 - y1) < exports.EPS;
}
exports.same = same;
function samePoint(a, b) {
    return Math.abs(a.x - b.x) < exports.EPS && Math.abs(a.y - b.y) < exports.EPS;
}
